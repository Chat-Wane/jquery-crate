...
function ShareDropdown(model, dropdown, linkView){
    dropdown.buttons[0].line.removeClass('disabled');
    dropdown.buttons[1].line.removeClass('disabled');
    dropdown.buttons[2].line.removeClass('disabled');
    
    dropdown.buttons[0].element.click( function(){
    ...
    dropdown.buttons[1].element.click( function(){
    ...
    dropdown.buttons[2].element.click( function(){
